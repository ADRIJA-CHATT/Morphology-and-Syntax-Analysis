...
`results/plots/locality_curves.png` — locality curves.

`results/plots/morphology_vs_locality.png` — descriptive morphology/locality scatter plot when enough complete rows exist.
